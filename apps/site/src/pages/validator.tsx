...
app.innerHTML = `
  ...
  <a href="/schema/1.0">v1.0 JSON Schema</a> — nothing is uploaded anywhere.</p>
...
function run(): void {
  ...
  resultRoot.render(<ValidationResult outcome={{ kind: "valid", doc: doc as CoffeeJSONDocument }} />);
}
